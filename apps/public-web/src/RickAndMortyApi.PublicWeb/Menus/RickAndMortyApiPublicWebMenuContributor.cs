...
namespace RickAndMortyApi.PublicWeb.Menus;

public class RickAndMortyApiPublicWebMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public RickAndMortyApiPublicWebMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<RickAndMortyApiResource>();

        // Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                RickAndMortyApiPublicWebMenus.HomePage,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 0
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                RickAndMortyApiPublicWebMenus.ProductPage,
                "Products",
                "/Products",
