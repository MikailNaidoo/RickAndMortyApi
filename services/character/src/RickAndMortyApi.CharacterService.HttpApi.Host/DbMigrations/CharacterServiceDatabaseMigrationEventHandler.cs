...
public class CharacterServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<CharacterServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public CharacterServiceDatabaseMigrationEventHandler(
