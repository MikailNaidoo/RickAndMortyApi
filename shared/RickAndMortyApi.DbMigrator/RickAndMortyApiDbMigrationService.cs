...
public class RickAndMortyApiDbMigrationService : ITransientDependency
{
    private readonly ILogger<RickAndMortyApiDbMigrationService> _logger;
    private readonly ITenantRepository _tenantRepository;
    private readonly IDataSeeder _dataSeeder;
    private readonly ICurrentTenant _currentTenant;
    private readonly IUnitOfWorkManager _unitOfWorkManager;

    public RickAndMortyApiDbMigrationService(
        ILogger<RickAndMortyApiDbMigrationService> logger,
        ...
        CancellationToken cancellationToken)
    {
        using (var uow = _unitOfWorkManager.Begin(requiresNew: true, isTransactional: false))
        {
          ...
          // await MigrateDatabaseAsync<WabbaLubbaDubDubServiceDbContext>(cancellationToken);
