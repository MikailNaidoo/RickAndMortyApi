...
using RickAndMortyApi.Shared.Hosting.Gateways;
using Ocelot.Middleware;
using RickAndMortyApi.CharacterService;
using Volo.Abp;
using Volo.Abp.Modularity;

namespace RickAndMortyApi.PublicWebGateway;

[DependsOn(
    typeof(RickAndMortyApiSharedHostingGatewaysModule),
    typeof(ProductServiceHttpApiModule),
    typeof(CharacterServiceHttpApiModule)
)]
public class RickAndMortyApiPublicWebGatewayModule : AbpModule
{
        ...
        SwaggerWithAuthConfigurationHelper.Configure(
            ...
            scopes: new
                Dictionary<string, string> /* Requested scopes for authorization code request and descriptions for swagger UI only */
                {
                        ...
                        {"CharacterService", "Character API"}
                },
